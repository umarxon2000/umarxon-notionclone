...
export const Sidebar = () => {
  ...
  return (
    <>
      <div className={cn("group/sidebar h-screen bg-secondary overflow-y-auto relative flex flex-col  w-60 z-50 ",
      ...
      ref={sidebarRef}>
        ...
        <div className=" absolute  right-0 top-0 w-1 h-full cursor-ew-resize bg-primary/10 opacity-0 group-hover/sidebar:opacity-100" onMouseDown={handleMouseDown} />
        
      </div>
      <div className={cn(" absolute top-0 left-60 z-50 w-[calc(100%-240px)]",
       isResetting && " transition-all ease-in duration-300",
       isMobile && " w-full left-0" )} ref={navbarRef}>
